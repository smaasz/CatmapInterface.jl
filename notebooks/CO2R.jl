...
# ╔═╡ fe854a50-7dc7-45ff-826a-2d0b69673b37
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ d5bf77b5-df64-4058-ae5e-d0966f3a57f2
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ 07ad456a-af2f-4888-83ea-d2de460b8b8a
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ b68753f7-ef6e-41d3-83c2-6a93e844a863
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ 023d5402-6900-44b5-962a-36784ed1b4d2
# ╠═╡ disabled = true
#=╠═╡
...
The acitivities of H₂O and e⁻ are set to be zero. The dependence on the rates on the applied voltage and surface charges are contained in the reaction rate constants.
...
begin
	...
	function we_breactions(
		...
		compute_rates_explicit!(rates, u, σ, ϕ_we, data)
		# bulk species
		f[ico] 		+= -rates[4] * S
		f[ico2] 	+= rates[1] * S
...
begin
	...
	function compute_rates_explicit!(
		...
		rates[1]  = kf[1] * (γ_co2 * u[ico2] / Hcp_CO2 / bar) * θ_free
		...
		rates[4] -= kr[4] * (γ_co * u[ico] / Hcp_CO / bar) * θ_free
...
# ╔═╡ d7b128cd-e3f5-411b-b1a2-b0aab0318471
# ╠═╡ disabled = true
#=╠═╡
